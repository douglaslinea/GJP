...
<ul class="tab-switch">
	...
	<li><a
		onclick="document.location.replace('{view}$URL_DEFAULT{/view}ogrupo')"
...
<div class="tab default-tab" id="tab0">
	...
	<div class="article-container">
		...
		<table>
			...
			<tr>
				<td><iframe type="text/html" width="320" height="240" src="{view}$grupo.arq_video_marca{/view}" frameborder="0"></iframe>
				</td>
				<td><img src="{view}$URL_DEFAULT../web_files/arq_din/{view}$grupo.img.logo_cropada{/view}{/view}"></td>
	...
	<button class="gray"
		onclick="document.location.replace('{view}$URL_DEFAULT{/view}ogrupo/editar/id_relacao_idioma/{view}$grupo.cod_relacao_idioma{/view}')" />
