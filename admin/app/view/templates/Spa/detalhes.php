...
<ul class="tab-switch">
	...
	<li><a
		onclick="document.location.replace('{view}$URL_DEFAULT{/view}spa/incluir')"
	...
	<li><a
		onclick="document.location.replace('{view}$URL_DEFAULT{/view}spa')"
...
<div class="tab default-tab" id="tab0">
	{view}if $dados_spa !== false{/view} {view}if
	...
	<button class="gray"
		onclick="document.location.replace('{view}$URL_DEFAULT{/view}spa/editar/id_relacao_idioma/{view}$spa.cod_relacao_idioma{/view}')" />
