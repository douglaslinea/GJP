...
<div class="article-container">
	...
	<div class="tab default-tab" id="tab0">
		{view}if $dados_lazer !== false{/view} {view}if
		...
		<table class="datatable" id="first-desc">
			...
			<tbody>
				{view}foreach from=$dados_lazer item=lazer{/view}
				<tr>
					<td><strong>{view}$lazer.txt_idioma{/view}</strong></td>
					<td>{view}$lazer.txt_titulo{/view}</td>
					<td>{view}$lazer.txt_razaoSocial{/view}</a></td>
					<td>
						<ul class="actions">
							<li><a class="view"
								href="{view}$URL_DEFAULT{/view}lazer/detalhes/id_relacao_idioma/{view}$lazer.cod_relacao_idioma{/view}"
								rel="tooltip" original-title="Ver detalhes">ver</a></li>
							<li><a class="edit"
								href="{view}$URL_DEFAULT{/view}lazer/editar/id_relacao_idioma/{view}$lazer.cod_relacao_idioma{/view}"
								rel="tooltip" original-title="{view}$textos_layout[42]{/view}">edit</a>
							</li>
							<li><a class="delete"
								onclick="javascript:exclusaoMultipla('{view}$URL_DEFAULT{/view}lazer/excluir/id_relacao_idioma/{view}$lazer.cod_relacao_idioma{/view}', '{view}$URL_DEFAULT{/view}lazer', '{view}$textos_layout[9]{/view}')"
