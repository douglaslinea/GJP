{view}include file="{view}$HEAD{/view}"{/view}
		...
		<div class="tab default-tab" id="tab0">
			<form name="frm_seo" id="frm_seo" action="javascript:acao('{view}$URL_DEFAULT{/view}seo/incluir', 'frm_seo', '{view}$URL_DEFAULT{/view}seo', new Array('{view}$textos_layout[2]{/view}', '{view}$textos_layout[1]{/view}'), 'btn_enviar')" method="post">
				<fieldset>
