                    ...
                    <thead>
                      <tr>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>{view}$cadast.dat_cadastro{/view}</td>
                            <td>{view}$cadast.txt_nome{/view}</td>
                            <td>{view}$cadast.txt_email{/view}</td>
                            <td>{view}$cadast.txt_comentario{/view}</td>
                            
                            <td>
                            <ul class="actions">
                                <li><a class="view" href="{view}$URL_DEFAULT{/view}faleconosco/detalhes/cod_id/{view}$cadast.cod_id{/view}" rel="tooltip" original-title="Ver detalhes">ver</a></li>
