		...
		<table class="datatable" id="first-desc">
			...
			<tbody>
				...
				<tr>
					...
					<td>{view}$textos.txt_razaoSocial{/view}</a></td>
					<td>
						<ul class="actions">
							<li><a class="view"
								href="{view}$URL_DEFAULT{/view}textoshoteis/detalhes/id_relacao_idioma/{view}$textos.cod_relacao_idioma{/view}"
								rel="tooltip" original-title="Ver detalhes">ver</a></li>
							<li><a class="edit"
								href="{view}$URL_DEFAULT{/view}textoshoteis/editar/id_relacao_idioma/{view}$textos.cod_relacao_idioma{/view}"
								rel="tooltip" original-title="{view}$textos_layout[42]{/view}">edit</a>
							</li>
							<li><a class="delete"
								onclick="javascript:exclusaoMultipla('{view}$URL_DEFAULT{/view}textoshoteis/excluir/id_relacao_idioma/{view}$textos.cod_relacao_idioma{/view}', '{view}$URL_DEFAULT{/view}textoshoteis', '{view}$textos_layout[9]{/view}')"
