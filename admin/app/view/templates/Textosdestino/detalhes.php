...
<ul class="tab-switch">
	...
	<li><a onclick="document.location.replace('{view}$URL_DEFAULT{/view}textosdestino')" href="" rel="tooltip" title="{view}$textos_layout[60]{/view}">{view}$textos_layout[60]{/view}</a>
	</li>
...
<div class="tab default-tab" id="tab0">
	...
	<div class="article-container">
		...
		<table>
			...
			<td width="50%" class="detalhes"><strong>Destino</strong><br />
				{view}$textos.txt_destinos{/view}</td>
	...
	<button class="gray"
		onclick="document.location.replace('{view}$URL_DEFAULT{/view}textosdestino/editar/id_relacao_idioma/{view}$textos.cod_relacao_idioma{/view}')" />

	{view}$textos_layout[42]{/view}
	</button>
	&nbsp&nbsp
	<button class="gray"
		onclick="document.location.replace('{view}$URL_DEFAULT{/view}textosdestino')" />
