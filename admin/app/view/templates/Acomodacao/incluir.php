...
<div class="tab default-tab" id="tab0">
	<form name="frm_contatos" id="frm_contatos" method="post" action="javascript:acao2('{view}$URL_DEFAULT{/view}acomodacao/incluir', 'frm_contatos','{view}$URL_DEFAULT{/view}acomodacao', new Array('{view}$textos_layout[59]{/view}', '{view}$textos_layout[1]{/view}'), 'class_erro', 'btn_enviar')">
	<!--<form name="frm_contatos" id="frm_contatos" method="post" action="{view}$URL_DEFAULT{/view}acomodacao/incluir">-->
			...
			<legend>
				...
				<dl>
					...
					<dd>
						...
						<p>{view}$textos_layout[47]{/view}</p>
						<div id="msg_erro_acomodacao" class="class_erro"></div>
					</dd>
					<dt>
						<label>Dimensão</label>
					</dt>
					<dd>
						<input type="text" name="txt_dimensao{view}$smarty.foreach.dad.iteration{/view}" id="txt_dimensao{view}$smarty.foreach.dad.iteration{/view}" onkeyup="mascara(this,soNumero);"	class="small" />
						<p>{view}$textos_layout[47]{/view}</p>
						<div id="msg_erro_dimensao" class="class_erro"></div>
					</dd>
					...
					<dd>
						<input type="text" name="txt_capacidade{view}$smarty.foreach.dad.iteration{/view}" id="txt_capacidade{view}$smarty.foreach.dad.iteration{/view}" onkeyup="mascara(this,soNumero);" class="small" />
						<p>{view}$textos_layout[47]{/view}</p>
						<div id="msg_erro_capacidade" class="class_erro"></div>
					</dd>
					...
					<dd>
						<input type="text" name="txt_ordem{view}$smarty.foreach.dad.iteration{/view}" id="txt_ordem{view}$smarty.foreach.dad.iteration{/view}" onkeyup="mascara(this,soNumero);" class="small" />
						<p>{view}$textos_layout[47]{/view}</p>
						<div id="msg_erro_ordem" class="class_erro"></div>
					</dd>
