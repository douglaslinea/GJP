		...
		<table class="datatable" id="first-desc">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<ul class="actions">
							<li><a class="view"	href="{view}$URL_DEFAULT{/view}acaosocial/detalhes/id_relacao_idioma/{view}$acao.cod_relacao_idioma{/view}"	rel="tooltip" original-title="Ver detalhes">ver</a></li>
							<li><a class="edit" href="{view}$URL_DEFAULT{/view}acaosocial/editar/id_relacao_idioma/{view}$acao.cod_relacao_idioma{/view}" rel="tooltip" original-title="{view}$textos_layout[42]{/view}">edit</a>
							</li>
							<li><a class="delete" onclick="javascript:exclusaoMultipla('{view}$URL_DEFAULT{/view}acaosocial/excluir/id_relacao_idioma/{view}$acao.cod_relacao_idioma{/view}', '{view}$URL_DEFAULT{/view}acaosocial', '{view}$textos_layout[9]{/view}')" rel="tooltip" original-title="{view}$textos_layout[48]{/view}">delete</a>
							</li>
