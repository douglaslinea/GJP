...
<ul class="tab-switch">
	...
	<li><a onclick="document.location.replace('{view}$URL_DEFAULT{/view}acaosocial')"href="" rel="tooltip" title="{view}$textos_layout[60]{/view}">{view}$textos_layout[60]{/view}</a>
	</li>
</ul>
</nav> </header>
...
<div class="tab default-tab" id="tab0">
	...
	<div class="article-container">
		...
		<table>
			...
			<tr>
				<td class="detalhes" colspan="2"><strong>Histórico</strong><br />
					{view}$acao.txt_historico{/view}</td>
	...
	<button class="gray" onclick="document.location.replace('{view}$URL_DEFAULT{/view}acaosocial/editar/id_relacao_idioma/{view}$acao.cod_relacao_idioma{/view}')" />

	{view}$textos_layout[42]{/view}
	</button>
	&nbsp&nbsp
	<button class="gray" onclick="document.location.replace('{view}$URL_DEFAULT{/view}acaosocial')" />
