...
<div class="tab default-tab" id="tab0">
	...
	{view}/if{/view}
		...
		<thead>
			...
			<tbody>
				{view}foreach from=$dados_linha item=linha{/view}
				<tr>
					<td><strong>{view}$linha.WebsiteIdiomas.txt_idioma{/view}</strong></td>
					<td>{view}$linha.txt_mes{/view}</td>
					<td>{view}$linha.txt_ano{/view}</td>
					<td>{view}$linha.txt_titulo{/view}</td>
					<td>
						<ul class="actions">
							<li><a class="view"	href="{view}$URL_DEFAULT{/view}linhatempo/detalhes/id_relacao_idioma/{view}$linha.cod_relacao_idioma{/view}"
								rel="tooltip" original-title="Ver detalhes">ver</a></li>
							<li><a class="edit"	href="{view}$URL_DEFAULT{/view}linhatempo/editar/id_relacao_idioma/{view}$linha.cod_relacao_idioma{/view}"
								rel="tooltip" original-title="{view}$textos_layout[42]{/view}">edit</a>
							</li>
							<li><a class="delete" onclick="javascript:exclusaoMultipla('{view}$URL_DEFAULT{/view}linhatempo/excluir/id_relacao_idioma/{view}$linha.cod_relacao_idioma{/view}', '{view}$URL_DEFAULT{/view}linhatempo', '{view}$textos_layout[9]{/view}')"
