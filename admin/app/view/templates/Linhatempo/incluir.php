...
<form name="frm_contatos" id="frm_contatos" method="post" action="javascript:acao2('{view}$URL_DEFAULT{/view}linhatempo/incluir', 'frm_contatos','{view}$URL_DEFAULT{/view}linhatempo', new Array('{view}$textos_layout[59]{/view}', '{view}$textos_layout[1]{/view}'), 'class_erro', 'btn_enviar')">
<!--<form name="frm_contatos" id="frm_contatos" method="post" action="{view}$URL_DEFAULT{/view}linhatempo/incluir">-->
		...
		<fieldset>	
			...
			<dt>
				...
				<dd>
				<input type="text" 	name="txt_ano" id="txt_ano"	maxlength="4" onkeyup="mascara(this,soNumero);" />
