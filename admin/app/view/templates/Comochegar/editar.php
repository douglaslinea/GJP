...
<ul class="tab-switch">
	...
	<li><a
		onclick="document.location.replace('{view}$URL_DEFAULT{/view}comochegar')"
...
<div class="tab default-tab" id="tab0">
	<form name="frm_contatos" id="frm_contatos" method="post" action="javascript:acao2('{view}$URL_DEFAULT{/view}comochegar/editar', 'frm_contatos','{view}$URL_DEFAULT{/view}comochegar', new Array('{view}$textos_layout[50]{/view}', '{view}$textos_layout[1]{/view}'), 'btn_enviar')">
<!--	<form name="frm_contatos" id="frm_contatos" method="post" action="{view}$URL_DEFAULT{/view}comochegar/editar">-->
	<fieldset>
		...
		{view}foreach from=$dados_chegar item=chegar name=con{/view}
		<fieldset>
			<legend>{view}$chegar.txt_idioma{/view}</legend>
				...
				<dl>
					...
					<dd>
						<strong><input type="text"
							...
							value="{view}$chegar.txt_titulo{/view}" class="medium" /> </strong>
						<p>{view}$textos_layout[47]{/view}</p>
						<div
					...
					<dd>
						<input type="text"
							...
							value="{view}$chegar.cod_ordem{/view}" class="small" />
						<p>{view}$textos_layout[47]{/view}</p>
					...
					<input type="hidden" name="cod_id{view}$smarty.foreach.con.iteration{/view}"id="cod_id{view}$smarty.foreach.con.iteration{/view}" value="{view}$chegar.cod_id{/view}"> 
				...
				value="{view}$chegar1.cod_id{/view}">
	...
	{view}/foreach{/view}
		...
		&nbsp;ou&nbsp; <a
			href="{view}$URL_DEFAULT{/view}comochegar/detalhes/id_relacao_idioma/{view}$chegar.cod_relacao_idioma{/view}" />Cancelar</a>
	</form>
