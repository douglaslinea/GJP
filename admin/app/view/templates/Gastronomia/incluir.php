...
<div
	class="tab default-tab" id="tab0">
		<form name="frm_contatos" id="frm_contatos" method="post" action="javascript:acao2('{view}$URL_DEFAULT{/view}gastronomia/incluir', 'frm_contatos','{view}$URL_DEFAULT{/view}gastronomia', new Array('{view}$textos_layout[59]{/view}', '{view}$textos_layout[1]{/view}'), 'class_erro', 'btn_enviar')">
	<!--<form name="frm_contatos" id="frm_contatos" method="post"	action="{view}$URL_DEFAULT{/view}gastronomia/incluir">-->
		...
		<fieldset>
			<legend>
				...
				<dl>
					...
					<dd>
						<input type="text"	name="cod_ordem{view}$smarty.foreach.dad.iteration{/view}"	id="cod_ordem{view}$smarty.foreach.dad.iteration{/view}"onkeyup="mascara(this,soNumero);" class="small" />
						<p>{view}$textos_layout[47]{/view}</p>
