...
<ul class="tab-switch">
	<li><a
		onclick="document.location.replace('{view}$URL_DEFAULT{/view}gastronomia/incluir')"
	...
	<li><a
		onclick="document.location.replace('{view}$URL_DEFAULT{/view}gastronomia')"
...
<div class="tab default-tab" id="tab0">
	<form name="frm_contatos" id="frm_contatos" method="post"
		action="javascript:acao2('{view}$URL_DEFAULT{/view}gastronomia/editar', 'frm_contatos','{view}$URL_DEFAULT{/view}gastronomia', new Array('{view}$textos_layout[50]{/view}', '{view}$textos_layout[1]{/view}'), 'btn_enviar')">
		<!--	<form name="frm_contatos" id="frm_contatos" method="post" action="{view}$URL_DEFAULT{/view}gastronomia/editar">-->
		...
		{view}foreach from=$dados_gastronomia item=gastronomia name=con{/view}
		<fieldset>
			<legend>{view}$gastronomia.txt_idioma{/view}</legend>
				<dl>
					<dt>
						<label>Titulo</label>
					</dt>
					<dd>
						<strong><input type="text"
							...
							value="{view}$gastronomia.txt_titulo{/view}" class="medium" /> </strong>
						<p>{view}$textos_layout[47]{/view}</p>
						<div
					...
					<dd>
						<input type="text"
							...
							value="{view}$gastronomia.cod_ordem{/view}" class="small" />
						<p>{view}$textos_layout[47]{/view}</p>
			...
			<input type="hidden"name="cod_id{view}$smarty.foreach.con.iteration{/view}"id="cod_id{view}$smarty.foreach.con.iteration{/view}"value="{view}$gastronomia.cod_id{/view}">
	 ...
	 {view}/foreach{/view}
		...
		&nbsp;ou&nbsp; <a
			href="{view}$URL_DEFAULT{/view}gastronomia/detalhes/id_relacao_idioma/{view}$gastronomia.cod_relacao_idioma{/view}" />Cancelar</a>
	</form>
