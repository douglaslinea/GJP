...
<div class="article-container">
	...
	<div class="tab default-tab" id="tab0">
		{view}if $dados_historia !== false{/view} {view}if isset($params.mensagem_confirmacao){/view}
		...
		<table class="datatable" id="first-desc">
			...
			<tbody>
				{view}foreach from=$dados_historia item=historia{/view}
				<tr>
					<td><strong>{view}$historia.txt_idioma{/view}</strong></td>
					<td>{view}$historia.txt_titulo{/view}</td>
					<td>{view}$historia.txt_destinos{/view}</a></td>
					<td>
						<ul class="actions">
							<li><a class="view"
								href="{view}$URL_DEFAULT{/view}historia/detalhes/id_relacao_idioma/{view}$historia.cod_relacao_idioma{/view}"
								rel="tooltip" original-title="Ver detalhes">ver</a></li>
							<li><a class="edit"
								href="{view}$URL_DEFAULT{/view}historia/editar/id_relacao_idioma/{view}$historia.cod_relacao_idioma{/view}"
								rel="tooltip" original-title="{view}$textos_layout[42]{/view}">edit</a>
							</li>
							<li><a class="delete"
								onclick="javascript:exclusaoMultipla('{view}$URL_DEFAULT{/view}historia/excluir/id_relacao_idioma/{view}$historia.cod_relacao_idioma{/view}', '{view}$URL_DEFAULT{/view}historia', '{view}$textos_layout[9]{/view}')"
