...
<script type="text/javascript" src="{view}$URL_DEFAULT{/view}web_files/js/prototype.js"></script>
	...
	<section role="main">
		...
		<article id="login-box">
			...
			<h1>Bem Vindo!</h1>
				...
				<form id="form_login" name="form_login" action="javascript:login('{view}$URL_DEFAULT{/view}index/login', 'form_login', '{view}$URL_DEFAULT{/view}logado', new Array('{view}$textos_layout[2]{/view}', '{view}$textos_layout[1]{/view}'), 'btn_enviar')" method="post" autocomplete="off">
					<fieldset>
						<dl>
							<dt>
								<label>Login</label>
