<?php /* Smarty version Smarty-3.1.1, created on 2012-10-23 10:02:17
         compiled from "app/view/templates/Cabecalho/index.php" */ ?>
<?php /*%%SmartyHeaderCode:47864792050868749d5cc52-59999479%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '47864792050868749d5cc52-59999479',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5086874a91d80',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5086874a91d80')) {function content_5086874a91d80($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
logado/" title="" class="dashboard no-submenu current">Painel de Controle</a></li>
				...
				<li <?php if (in_array($_smarty_tpl->tpl_vars['CONTROLLER_ATUAL']->value,array('Hoteis','Contatos','Acomodacao','Infraestrutura','Gastronomia','Spa','Lazer','ServicosEsp','Facilidades','Comochegar','Distancias','Textoshoteis'))){?> class="current" <?php }?> ><a title="Hoteis" class="hotel">Hoteis</a>
...
facilidades" title="Facilidades">Facilidades</a></li><?php }?>
                    ...
                    <?php if (isset($_SESSION['UserPermissoes'][1])){?>
						<li <?php if ($_smarty_tpl->tpl_vars['CONTROLLER_ATUAL']->value=='Distancias'){?> class="sub_menu" <?php }?>><a href="<?php echo $_smarty_tpl->tpl_vars['URL_DEFAULT']->value;?>
distancias" title="Distâncias">Principais Distâncias</a></li><?php }?>
...
noticias" title="Notícias">Notícias</a></li>
                    <?php }?>
...
configuracoes/detalhes/id/1" title="Downloads">Downloads</a></li>
				...
				<li <?php if (in_array($_smarty_tpl->tpl_vars['CONTROLLER_ATUAL']->value,array('Consulta','Linhatempo','Reconhecimento','Acaosocial','Acaosocialnoticias','Investimentos','Parceiros'))){?> class="current" <?php }?>><a title="GrupoGJP" class="winner">Grupo GJP</a>
					<ul>
                    <?php if (isset($_SESSION['UserPermissoes'][4])){?>
...
linhatempo" title="Linha do Tempo">Linha do Tempo</a></li>
                    ...
                    <?php if (isset($_SESSION['UserPermissoes'][14])){?>
						<li <?php if ($_smarty_tpl->tpl_vars['CONTROLLER_ATUAL']->value=='Reconhecimento'){?> class="sub_menu" <?php }?>><a href="<?php echo $_smarty_tpl->tpl_vars['URL_DEFAULT']->value;?>
reconhecimento" title="Reconhecimento">Reconhecimento</a></li>
                    <?php }?>
