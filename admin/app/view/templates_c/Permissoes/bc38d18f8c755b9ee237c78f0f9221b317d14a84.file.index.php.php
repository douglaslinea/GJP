...
<?php /*%%SmartyHeaderCode:597596620505c9b1c9a2fc3-20160075%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '597596620505c9b1c9a2fc3-20160075',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_505c9b1d51113',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_505c9b1d51113')) {function content_505c9b1d51113($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
" title="" class="dashboard no-submenu current">Painel de Controle</a></li>
				...
				<li <?php if (in_array($_smarty_tpl->tpl_vars['CONTROLLER_ATUAL']->value,array('Hoteis','Contatos','Acomodacao','Infraestrutura','Gastronomia','SPA','Lazer','ServicosEsp','ComoChegar','PrincipalDist','Textos'))){?> class="current" <?php }?> ><a title="Hoteis" class="hotel">Hoteis</a>
...
hoteis/" title="Hoites">Hoteis</a></li><?php }?>
...
textos" title="Infraestrutura">Infraestrutura</a></li><?php }?>
...
textos-layout" title="Gastronomia">Gastronomia</a></li><?php }?>
...
textos-layout" title="SPA">SPA</a></li><?php }?>
...
textos-layout" title="Lazer">Lazer</a></li><?php }?>
...
textos-layout" title="ComoChegar">Como Chegar</a></li><?php }?>
...
textos-layout" title="Textos">Textos Introdutórios</a></li><?php }?>
...
configuracoes/detalhes/id/1" title="RelacaoPublica">Relações Publicas</a></li>
				 ...
				 <li <?php if (in_array($_smarty_tpl->tpl_vars['CONTROLLER_ATUAL']->value,array('Destino','Clima','Atracao','Historia','Textos','Links'))){?> class="current" <?php }?> ><a title="Destinos" class="projects">Destinos</a>
...
configuracoes/detalhes/id/1" title="Atracao">Atração</a></li>
                    <?php }?>
...
configuracoes/detalhes/id/1" title="Historia">História</a></li>
                    <?php }?>
                    
                    <?php if (isset($_SESSION['UserPermissoes'][4])){?>
						<li <?php if ($_smarty_tpl->tpl_vars['CONTROLLER_ATUAL']->value=='Textos'){?> class="sub_menu" <?php }?>><a href="<?php echo $_smarty_tpl->tpl_vars['URL_DEFAULT']->value;?>
configuracoes/detalhes/id/1" title="Textos">Textos Introdutórios</a></li>
                    <?php }?>
...
configuracoes/detalhes/id/1" title="Downloads">Downloads</a></li>
				...
				<li <?php if (in_array($_smarty_tpl->tpl_vars['CONTROLLER_ATUAL']->value,array('Consulta','LinhaTempo','Premios','AcaoSocial','Investimentos','Parceiros'))){?> class="current" <?php }?>><a title="GrupoGJP" class="winner">Grupo GJP</a>
					<ul>
                    <?php if (isset($_SESSION['UserPermissoes'][4])){?>
...
configuracoes/detalhes/id/1" title="Consulta">Consulta</a></li>
                    <?php }?>
...
idiomas" title="LinhaTempo">Linha do Tempo</a></li>
                    <?php }?>                        
...
seo" title="Premios">Prêmios</a></li>
                    <?php }?>
...
seo" title="AcaoSocial">Ação Social</a></li>
                    <?php }?>
...
seo" title="Parceiros">Parceiros</a></li>
                    <?php }?>
					</ul>
				</li>
