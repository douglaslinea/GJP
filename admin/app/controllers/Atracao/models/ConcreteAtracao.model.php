...
class ConcreteAtracao
{
	...
	public function ExcluirAtracao($parametros)
	{
		LibFactory::getInstance(null,null,'Zend/Json.php');
	...
	public function SelectAtracaoId($parametros)
	{
