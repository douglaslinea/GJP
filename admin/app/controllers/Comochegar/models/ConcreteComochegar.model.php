...
class ConcreteComochegar
{
	...
	public function IncluirChegar($parametros)
	{
		...
		$ComponenteValidacao = getComponent('validacoes/comochegar.validacao','comochegarValidacao');
	...
	public function ExcluirChegar($parametros)
	{
	...
	public function SelectChegarId($parametros)
	{
