	...
	function Wysiwyg() {
		this.controls = {
			...
			html: {
				...
				tooltip: "Ver c&oacute;digo-fonte"
			},
			...
			insertHorizontalRule: {
				...
				visible: true,
				tags: ["hr"],
				tooltip: "Inserir r&eacute;gua horizontal"
			},
			...
			insertOrderedList: {
				...
				visible: true,
				tags: ["ol"],
				tooltip: "Inserir lista num&eacute;rica"
			},
			...
			removeFormat: {
				...
				tooltip: "Remover formata&ccedil;&atilde;o"
			},
		...
		this.defaults = {
			...
			messages: {
				nonSelection: "Selecione o trecho do texto que você quer linkar"
			},
