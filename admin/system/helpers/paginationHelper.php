...
class paginationHelper {	
			 ...
			 * @param Integer $pagina_atual - página acessada no momento
			 * @param Integer $registros_por_pagina - quantidade de registros por cada página
			 * @param String $url_default - url padrão a ser acessada na paginação
			 * @param array $url_params - parâmetros da requisição a serem agregados na URL da paginação (Parâmetros GET/POST)
			...
			/**
			 * Executa a paginação no banco de dados
