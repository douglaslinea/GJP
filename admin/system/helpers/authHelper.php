...
class authHelper
{
	...
	public function validacao($usuario, $senha)
	{
		...
		$Validation	->set($usuario, "<div class='notification error'>Informe o login</div>",'txt_login','msg_erro_login')->obrigatorio()
					->set($senha, "<div class='notification error'>Informe a senha</div>",'txt_senha','msg_erro_senha')->obrigatorio();
